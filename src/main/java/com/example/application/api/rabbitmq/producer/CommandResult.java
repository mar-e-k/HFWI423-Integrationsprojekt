...
public class CommandResult<DTO> {
    ...
    public static <DTO> CommandResult<DTO> success(DomainCommand command, DTO payload) {
        return new CommandResult<>(true, command, payload, null);
    }

    public static <DTO> CommandResult<DTO> failure(DomainCommand command, String error) {
