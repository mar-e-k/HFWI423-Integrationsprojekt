...
import de.fhdw.vendix.commons.api.domain.account_role.web.AccountRoleCommandApi;
import de.fhdw.vendix.commons.api.structure.port.CommandPort;

public interface AccountRoleCommandPort extends CommandPort, AccountRoleCommandApi {
