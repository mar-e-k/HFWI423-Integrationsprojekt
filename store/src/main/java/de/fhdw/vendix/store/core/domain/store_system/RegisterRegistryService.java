...
@Service
class RegisterRegistryService {

    // TODO: this needs to be rewritten in something like StoreConnectionsContext
...
//
//    public RegisterRegistryService(StoreContext storeContext, RegisterService registerService) {
...
//        }
//
//        List<Register> registers = registerService.findAllByStore(storeContext.getStore());
//
