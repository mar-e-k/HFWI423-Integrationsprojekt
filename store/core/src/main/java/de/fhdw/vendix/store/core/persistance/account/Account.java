...
public class Account extends AbstractSpringDataAuditingEntity<Long> {
    ...
    public Account(UUID uuid, String firstName, String lastName, String password) {
        this.uuid = uuid;
    ...
    public Account(UUID uuid, String username, String password, String firstName, String lastName) {
        this.uuid = uuid;
        this.firstName = firstName;
        this.lastName = lastName;
    ...
    @Default
    public Account(@Nullable Long id, UUID uuid, String username, String password, String firstName, @Nullable String middleName, String lastName, @Nullable String phone, @Nullable String email) {
        super(id);
        this.uuid = uuid;
        this.firstName = firstName;
