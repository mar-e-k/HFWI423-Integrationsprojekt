...
@Component
public class StoreContextInitializationDelegator {

    private static final Logger log = LoggerFactory.getLogger(StoreContextInitializationDelegator.class);
    ...
    public StoreContextInitializationDelegator(
