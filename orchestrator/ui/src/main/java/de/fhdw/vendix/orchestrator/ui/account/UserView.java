...
import de.fhdw.vendix.orchestrator.core.domain.account.Account;import de.fhdw.vendix.orchestrator.core.domain.account.AccountService;
...
public class UserView extends VerticalLayout {
    ...
    public UserView(AccountService accountService) {
